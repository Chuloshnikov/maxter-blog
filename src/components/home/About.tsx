...
const About = () => {
  return (
    <section id='about' className='mt-8 flex flex-col-reverse lg:flex-row gap-12 xl:gap-16 pt-12 max-h-[500px]'>
      ...
      <div className='p-6 flex flex-col gap-4 max-w-[500px] flex-1'>
          ...
          <blockquote className='text-lg md:text-2xl font-bold mt-8'>And remember: Control your thoughts, they can come true.</blockquote>
      </div>
    </section>
  )
}
