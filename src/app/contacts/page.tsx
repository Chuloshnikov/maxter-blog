...
return (
    <main className="flex min-h-[calc(100vh-21.1rem)] flex-col items-center justify-between">
        <div className='p-4 flex flex-col mdl:flex-row justify-between gap-10 mdl:gap-16 mb-6 mdl:mb-12'>
            ...
            <div className="mdl:mt-2">
                <div className='w-full mdl:max-w-[400px]'>
                    <video autoPlay muted loop>
                        <source src="/content/community.mp4" type="video/mp4" />
                    </video>
                </div>
                <div className="bg-accentBg text-white p-12 lg:pb-20 flex flex-col gap-4">
                <div>
